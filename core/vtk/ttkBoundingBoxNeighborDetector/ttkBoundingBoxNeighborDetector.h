...
///   - standalone/BoundingBoxNeighborDetector/main.cpp
///
/// See the related ParaView example state files for usage examples within a
/// VTK pipeline.
///
/// \sa ttk::BoundingBoxNeighborDetector
/// \sa ttkAlgorithm

#pragma once

// VTK Module
#include <ttkBoundingBoxNeighborDetectorModule.h>
 ...
 *
 * NAME
 *   ttkBoundingBoxNeighborDetector
 * DEPENDS
 *   ttkAlgorithm
 *   VTK::FiltersSources
 */
...
private:
   ...
   */
  std::string OutputArrayName{"Neighbors"};
...
public:
   ...
   */
  static ttkBoundingBoxNeighborDetector *New();
  vtkTypeMacro(ttkBoundingBoxNeighborDetector, ttkAlgorithm);
...
protected:
   ...
   */
  ttkBoundingBoxNeighborDetector();
  virtual ~ttkBoundingBoxNeighborDetector() override = default;
