...
///   - standalone/MorseSegmentation/main.cpp
///
/// See the related ParaView example state files for usage examples within a
/// VTK pipeline.
///
/// \sa ttk::MorseSegmentation
/// \sa ttkAlgorithm

#pragma once

// VTK Module
#include <ttkMorseSegmentationModule.h>
...
// TTK Base Includes
#include <MorseSegmentation.h>

class TTKMORSESEGMENTATION_EXPORT ttkMorseSegmentation
  : public ttkAlgorithm // we inherit from the generic ttkAlgorithm class
  ,
    protected ttk::MorseSegmentation // and we inherit from the base class
{
private:
  /**
   ...
   */
  std::string OutputArrayName{"MorseSmaleManifold"};
...
public:
   ...
   */
  static ttkMorseSegmentation *New();
  vtkTypeMacro(ttkMorseSegmentation, ttkAlgorithm);
