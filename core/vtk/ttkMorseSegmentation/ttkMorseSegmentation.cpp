#include <ttkMorseSegmentation.h>
...
vtkStandardNewMacro(ttkMorseSegmentation);
 ...
 */
ttkMorseSegmentation::ttkMorseSegmentation() {
...
int ttkMorseSegmentation::RequestData(vtkInformation *ttkNotUsed(request),
  ...
  //       call SetInputArrayToProcess (see MorseSegmentation.xml file).
  //
  ...
  vtkSmartPointer<vtkDataArray> outputArray
    = vtkSmartPointer<vtkDataArray>::Take(ascendingManifold->NewInstance());
  ...
  outputArray->SetNumberOfTuples(ascendingManifold->GetNumberOfTuples());
  ...
  ttkVtkTemplateMacro(ascendingManifold->GetDataType(), triangulation->getType(),
                      (status = this->computeAverages<VTK_TT, TTK_TT>(
                         ...
                         (VTK_TT *)ttkUtils::GetVoidPointer(descendingManifold),
