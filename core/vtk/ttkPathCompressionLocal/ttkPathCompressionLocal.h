...
/// \date May 2023.
///
/// \brief TTK VTK-filter that wraps the ttk::PathCompressionLocal module.
///
...
///   - standalone/PathCompressionLocal/main.cpp
///
...
// VTK Module
#include <ttkPathCompressionLocalModule.h>
...
class TTKPATHCOMPRESSIONLOCAL_EXPORT ttkPathCompressionLocal
  : public ttkAlgorithm,
    protected ttk::PathCompressionLocal {

public:
  static ttkPathCompressionLocal *New();

  vtkTypeMacro(ttkPathCompressionLocal, ttkAlgorithm);
