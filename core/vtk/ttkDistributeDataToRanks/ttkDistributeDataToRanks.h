...
/// \ingroup vtk
/// \class ttk::DistributeDataToRanks
/// \author Michael Will <mswill@rhrk.uni-kl.de>
/// \date 2022.
///
/// \brief TTK VTK-filter that wraps the ttk::DistributeDataToRanks
/// module.
///
/// This VTK filter uses the ttk::DistributeDataToRanks module that
...
///   - standalone/DistributeDataToRanks/main.cpp
///
/// See the related ParaView example state files for usage examples within a
/// VTK pipeline.
///
/// \sa ttk::DistributeDataToRanks
/// \sa ttkAlgorithm

#pragma once

// VTK Module
#include <ttkDistributeDataToRanksModule.h>
 ...
 *
 * NAME
 *   ttkDistributeDataToRanks
 * DEPENDS
 *   ttkAlgorithm
 *   VTK::FiltersSources
 */

class TTKDISTRIBUTEDATATORANKS_EXPORT ttkDistributeDataToRanks
...
public:
   ...
   */
  static ttkDistributeDataToRanks *New();
  vtkTypeMacro(ttkDistributeDataToRanks, ttkAlgorithm);
...
protected:
   ...
   */
  ttkDistributeDataToRanks();
  virtual ~ttkDistributeDataToRanks() override = default;
