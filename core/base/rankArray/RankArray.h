...
/// \ingroup base
/// \class ttk::RankArray
/// \author Michae Will <mswill@rhrkr.uni-kl.de>
/// \date 2022.
///
/// This module defines the %RankArray class that computes for each vertex of a
...
namespace ttk {
  ...
  /**
   * The RankArray class provides methods to compute for each vertex of a
   * triangulation the average scalar value of itself and its direct neighbors.
   */
  class RankArray : virtual public Debug {
