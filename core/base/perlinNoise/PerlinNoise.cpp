...
ttk::PerlinNoise::PerlinNoise() {
  // inherited from Debug: prefix will be printed at the beginning of every msg
  this->setDebugMsgPrefix("PerlinNoise");

  // Setting permutation table
  pT = {151, 160, 137, 91,  90,  15,  131, 13,  201, 95,  96,  53,  194, 233,
        ...
        215, 61,  156, 180};
  pT.insert(pT.end(), pT.begin(), pT.end());
}
