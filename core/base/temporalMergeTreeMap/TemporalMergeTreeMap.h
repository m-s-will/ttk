...
///
/// \ingroup base
/// \class ttk::TemporalMergeTreeMap
/// \author Your Name Here <your.email@address.here>
/// \date The Date Here.
///
/// This module defines the %TemporalMergeTreeMap class that computes for each vertex of a
/// triangulation the average scalar value of itself and its direct neighbors.
///
/// \b Related \b publication: \n
/// 'TemporalMergeTreeMap'
...
namespace ttk {
  ...
  /**
   * The TemporalMergeTreeMap class provides methods to compute for each vertex of a
   * triangulation the average scalar value of itself and its direct neighbors.
   */
  class TemporalMergeTreeMap : virtual public Debug {
