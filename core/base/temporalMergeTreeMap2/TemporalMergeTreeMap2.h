...
///
/// \ingroup base
/// \class ttk::TemporalMergeTreeMap2
/// \author Your Name Here <your.email@address.here>
/// \date The Date Here.
///
/// This module defines the %TemporalMergeTreeMap2 class that computes for each vertex of a
/// triangulation the average scalar value of itself and its direct neighbors.
///
/// \b Related \b publication: \n
/// 'TemporalMergeTreeMap2'
...
namespace ttk {
  ...
  /**
   * The TemporalMergeTreeMap2 class provides methods to compute for each vertex of a
   * triangulation the average scalar value of itself and its direct neighbors.
   */
  class TemporalMergeTreeMap2 : virtual public Debug {
